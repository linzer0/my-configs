...
namespace UnityEngine
{
  ...
  public class Transform : Component, IEnumerable
  {
    ...
    /// <summary>
    ///   <para>Sets the position and rotation of the Transform component in local space (i.e. relative to its parent transform).</para>
    /// </summary>
    /// <param name="localPosition"></param>
    /// <param name="localRotation"></param>
    public void SetLocalPositionAndRotation(Vector3 localPosition, Quaternion localRotation) => this.SetLocalPositionAndRotation_Injected(ref localPosition, ref localRotation);

    [MethodImpl(MethodImplOptions.InternalCall)]
    public extern void GetPositionAndRotation(out Vector3 position, out Quaternion rotation);

    [MethodImpl(MethodImplOptions.InternalCall)]
    public extern void GetLocalPositionAndRotation(
    ...
    /// <summary>
    ///   <para>Finds a child by name n and returns it.</para>
    /// </summary>
    /// <param name="n">Name of child to be found.</param>
    /// <returns>
    ///   <para>The found child transform. Null if child with matching name isn't found.</para>
    /// </returns>
    ...
    {
      get => this.IsConstrainProportionsScale();
      set => this.SetConstrainProportionsScale(value);
    }
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    private extern void SetLocalPositionAndRotation_Injected(
