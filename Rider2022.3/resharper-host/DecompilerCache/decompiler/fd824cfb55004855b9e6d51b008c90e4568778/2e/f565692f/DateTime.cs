...
namespace System
{
    ...
    IEquatable<DateTime>
  {
    ...
    [__DynamicallyInvokable]
    public DateTime(long ticks) => this.dateData = ticks >= 0L && ticks <= 3155378975999999999L ? (ulong) ticks : throw new ArgumentOutOfRangeException(nameof (ticks), Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
    ...
    [__DynamicallyInvokable]
    public DateTime(int year, int month, int day) => this.dateData = (ulong) DateTime.DateToTicks(year, month, day);
    ...
    internal long InternalTicks => (long) this.dateData & 4611686018427387903L;

    private ulong InternalKind => this.dateData & 13835058055282163712UL;
    ...
    [__DynamicallyInvokable]
    public override bool Equals(object value) => value is DateTime dateTime && this.InternalTicks == dateTime.InternalTicks;
    ...
    [__DynamicallyInvokable]
    public bool IsDaylightSavingTime() => this.Kind != DateTimeKind.Utc && TimeZoneInfo.Local.IsDaylightSavingTime(this, TimeZoneInfoOptions.NoThrowOnInvalidTime);

    [__DynamicallyInvokable]
    public static DateTime SpecifyKind(DateTime value, DateTimeKind kind) => new DateTime(value.InternalTicks, kind);
    ...
    internal static DateTime CreateDateTimeFromSystemTime(ref DateTime.FullSystemTime time) => new DateTime((ulong) (DateTime.DateToTicks((int) time.wYear, (int) time.wMonth, (int) time.wDay) + DateTime.TimeToTicks((int) time.wHour, (int) time.wMinute, (int) time.wSecond) + (long) time.wMillisecond * 10000L + time.hundredNanoSecond | 4611686018427387904L));
    ...
    [__DynamicallyInvokable]
    public static DateTime Parse(string s) => DateTimeParse.Parse(s, DateTimeFormatInfo.CurrentInfo, DateTimeStyles.None);

    [__DynamicallyInvokable]
    public static DateTime Parse(string s, IFormatProvider provider) => DateTimeParse.Parse(s, DateTimeFormatInfo.GetInstance(provider), DateTimeStyles.None);
    ...
    [__DynamicallyInvokable]
    public static DateTime ParseExact(string s, string format, IFormatProvider provider) => DateTimeParse.ParseExact(s, format, DateTimeFormatInfo.GetInstance(provider), DateTimeStyles.None);
    ...
    [__DynamicallyInvokable]
    public TimeSpan Subtract(DateTime value) => new TimeSpan(this.InternalTicks - value.InternalTicks);
    ...
    public string ToLongDateString() => DateTimeFormat.Format(this, "D", DateTimeFormatInfo.CurrentInfo);

    public string ToLongTimeString() => DateTimeFormat.Format(this, "T", DateTimeFormatInfo.CurrentInfo);

    public string ToShortDateString() => DateTimeFormat.Format(this, "d", DateTimeFormatInfo.CurrentInfo);

    public string ToShortTimeString() => DateTimeFormat.Format(this, "t", DateTimeFormatInfo.CurrentInfo);

    [__DynamicallyInvokable]
    public override string ToString() => DateTimeFormat.Format(this, (string) null, DateTimeFormatInfo.CurrentInfo);

    [__DynamicallyInvokable]
    public string ToString(string format) => DateTimeFormat.Format(this, format, DateTimeFormatInfo.CurrentInfo);

    [__DynamicallyInvokable]
    public string ToString(IFormatProvider provider) => DateTimeFormat.Format(this, (string) null, DateTimeFormatInfo.GetInstance(provider));

    [__DynamicallyInvokable]
    public string ToString(string format, IFormatProvider provider) => DateTimeFormat.Format(this, format, DateTimeFormatInfo.GetInstance(provider));

    [__DynamicallyInvokable]
    public DateTime ToUniversalTime() => TimeZoneInfo.ConvertTimeToUtc(this, TimeZoneInfoOptions.NoThrowOnInvalidTime);

    [__DynamicallyInvokable]
    public static bool TryParse(string s, out DateTime result) => DateTimeParse.TryParse(s, DateTimeFormatInfo.CurrentInfo, DateTimeStyles.None, out result);
    ...
    [__DynamicallyInvokable]
    bool IConvertible.ToBoolean(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Boolean"));

    [__DynamicallyInvokable]
    char IConvertible.ToChar(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Char"));

    [__DynamicallyInvokable]
    sbyte IConvertible.ToSByte(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "SByte"));

    [__DynamicallyInvokable]
    byte IConvertible.ToByte(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Byte"));

    [__DynamicallyInvokable]
    short IConvertible.ToInt16(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Int16"));

    [__DynamicallyInvokable]
    ushort IConvertible.ToUInt16(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "UInt16"));

    [__DynamicallyInvokable]
    int IConvertible.ToInt32(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Int32"));

    [__DynamicallyInvokable]
    uint IConvertible.ToUInt32(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "UInt32"));

    [__DynamicallyInvokable]
    long IConvertible.ToInt64(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Int64"));

    [__DynamicallyInvokable]
    ulong IConvertible.ToUInt64(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "UInt64"));

    [__DynamicallyInvokable]
    float IConvertible.ToSingle(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Single"));

    [__DynamicallyInvokable]
    double IConvertible.ToDouble(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Double"));

    [__DynamicallyInvokable]
    Decimal IConvertible.ToDecimal(IFormatProvider provider) => throw new InvalidCastException(Environment.GetResourceString("InvalidCast_FromTo", (object) nameof (DateTime), (object) "Decimal"));
